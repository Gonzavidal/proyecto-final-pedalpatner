...
Revision ID: 600a78e619c3
Revises: 
Create Date: 2023-05-04 21:09:06.511240
...
def upgrade():
    ...
    sa.Column('mantencion', sa.Integer(), nullable=True),
    sa.Column('indumentaria', sa.Integer(), nullable=True),
    sa.Column('bicicletas', sa.Integer(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('tallernom', sa.String(length=110), nullable=True),
    sa.Column('regiontall', sa.String(length=110), nullable=True),
