...
export const Login = () => {
    ...
    return (
        <div className="container-fluid position-relative d-inline-block my-2 px-0" id="mainView">
            ...
            <form className="col-12 mt-1 px-5 position-relative fs-4" onSubmit={actions.handleSubmitLogin}>
                ...
                onChange={actions.handleChange}
                        ...
                        <div className="col-8 form-group my-3 d-flex">
                            <label className="pt-2 mx-3" htmlFor="#inputPassword">Password</label>
                            <input
                type="password"
                className="form-control"
                name="password"
                ...
                onChange={actions.handleChange}
                    ...
                    <div className="row mt-3">
                        <button type="submit" onClick={actions.handleSubmitLogin}className="col-sm-1 mx-auto btn btn-danger fs-5 px-2">Entrar</button>
                    </div>
                </div>
            </form>
         </div>
