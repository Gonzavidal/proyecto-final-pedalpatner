          ...
          <div className="card container-fluid p-0 m-0 my-2" id="structure">
            <div className="row justify-content-center mx-0">
              ...
              <div className="col-8 card-body">
                ...
                <h2 className="card-title my-1 text-end">
                  El ciclista neerlandés Mathieu van der Poel conquista su
                  primera París-Roubaix
                </h2>
                <div className="overflow-y-scroll">
                  <p className="card-text text-end overflow-y-scroll">
                    gitLa 120ª edición de la carrera de la francesa
                    París-Roubaix de un solo día se celebró este domingo. El
                    neerlandés Mathieu van der Poel conquistó su primera
                    París-Roubaix fascinando con su ataque a 15 km del final. Un
                    total de 175 ciclistas pedalearon 257 kilómetros.
                  </p>
                </div>
              </div>
            </div>
