...
{/* general card structure: photo + text
intended to use for eventos + noticias */}
const Estructura1 = () => {
    return (
                ...
                <div className="card container-fluid p-0 m-0" id="structure">
                    <div className="row justify-content-center m-0">
                        <div className="col-4">
                            ...
                            <img src={Mapa} alt="Mapa" id="regPhoto" className="img-fluid" /></div>
                        </div>
                        <div className="col-8 card-body">
                            ...
                            <div className="overflow-y-scroll">
                                <p className="card-text text-end">Todos los domingo del año entre las 09:00 y 14:00, más de 40 km de vías en la Región Metropolitana se cierran al tránsito motorizado. 
